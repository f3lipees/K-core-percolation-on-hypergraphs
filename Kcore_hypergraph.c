...
***************************************************************************************************
 * Code that  generates random hypergraph and performs (1st neighbour) hypergraph (k,s)-core percolation 
 * This code uses:
 * N  Number of nodes
...
int Recurrence( int i , int cluster_size, int ncluster){
	int j, n3,aus_cluster_size,n,j2,aus,is;
...
/*%%%%%%%%%%%%SIMULATION%%%%%%%%%%%%%%%%%*/
    ...
    gp3=fopen("Kcore_Hypergraph.txt","w");
        for (nc=0;nc<100;nc++){
            f=nc*0.01;
